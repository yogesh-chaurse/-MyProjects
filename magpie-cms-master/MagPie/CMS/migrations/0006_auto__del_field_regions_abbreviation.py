...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Regions.abbreviation'
        db.delete_column(u'CMS_regions', 'abbreviation')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Regions.abbreviation'
        raise RuntimeError("Cannot reverse this migration. 'Regions.abbreviation' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Regions.abbreviation'
        db.add_column(u'CMS_regions', 'abbreviation',
