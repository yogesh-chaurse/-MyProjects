...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dynamic_Contents.value'
        db.add_column(u'CMS_dynamic_contents', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dynamic_Contents.value'
        db.delete_column(u'CMS_dynamic_contents', 'value')
