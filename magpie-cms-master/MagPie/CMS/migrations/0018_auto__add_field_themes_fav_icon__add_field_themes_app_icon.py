...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Themes.fav_icon'
        db.add_column(u'CMS_themes', 'fav_icon',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Themes.app_icon'
        db.add_column(u'CMS_themes', 'app_icon',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Themes.fav_icon'
        db.delete_column(u'CMS_themes', 'fav_icon')

        # Deleting field 'Themes.app_icon'
        db.delete_column(u'CMS_themes', 'app_icon')
