...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institutions.direct_claim_allowed'
        db.alter_column(u'CMS_institutions', 'direct_claim_allowed', self.gf('django.db.models.fields.NullBooleanField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'Institutions.direct_claim_allowed'
        db.alter_column(u'CMS_institutions', 'direct_claim_allowed', self.gf('django.db.models.fields.BooleanField')(max_length=1))
    ...
    models = {
        ...
        u'CMS.institutions': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'direct_claim_allowed': ('django.db.models.fields.NullBooleanField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
