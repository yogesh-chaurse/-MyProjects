...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Version_Updates'
        db.create_table(u'CMS_version_updates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('os_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('minor_version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('major_version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('expiry', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('is_forcefully', self.gf('django.db.models.fields.BooleanField')(default=False, max_length=1)),
        ...
        db.send_create_signal(u'CMS', ['Version_Updates'])


    def backwards(self, orm):
        # Deleting model 'Version_Updates'
        db.delete_table(u'CMS_version_updates')
