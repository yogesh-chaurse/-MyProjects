...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Dynamic_Contents', fields ['content']
        db.delete_unique(u'CMS_dynamic_contents', ['content_id'])


        # Changing field 'Dynamic_Contents.content'
        db.alter_column(u'CMS_dynamic_contents', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CMS.Institutions']))

    def backwards(self, orm):

        # Changing field 'Dynamic_Contents.content'
        db.alter_column(u'CMS_dynamic_contents', 'content_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['CMS.Institutions']))
        # Adding unique constraint on 'Dynamic_Contents', fields ['content']
        db.create_unique(u'CMS_dynamic_contents', ['content_id'])
