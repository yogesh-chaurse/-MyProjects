...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Business_Partners'
        db.create_table(u'CMS_business_partners', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('contact', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('authorisation_key', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'CMS', ['Business_Partners'])


    def backwards(self, orm):
        # Deleting model 'Business_Partners'
        db.delete_table(u'CMS_business_partners')
