...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Version_Updates.major_version'
        db.delete_column(u'CMS_version_updates', 'major_version')

        # Deleting field 'Version_Updates.minor_version'
        db.delete_column(u'CMS_version_updates', 'minor_version')

        # Adding field 'Version_Updates.minimum_version'
        db.add_column(u'CMS_version_updates', 'minimum_version',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Version_Updates.latest_version'
        db.add_column(u'CMS_version_updates', 'latest_version',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Version_Updates.major_version'
        db.add_column(u'CMS_version_updates', 'major_version',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Version_Updates.minor_version'
        db.add_column(u'CMS_version_updates', 'minor_version',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Version_Updates.minimum_version'
        db.delete_column(u'CMS_version_updates', 'minimum_version')

        # Deleting field 'Version_Updates.latest_version'
        db.delete_column(u'CMS_version_updates', 'latest_version')
    ...
    models = {
        ...
        u'CMS.version_updates': {
            ...
            'latest_version': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'minimum_version': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
