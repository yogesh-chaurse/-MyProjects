...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business_Partners.slug'
        db.add_column(u'CMS_business_partners', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='l', max_length=255),
                      keep_default=False)
    ...
    models = {
        ...
        u'CMS.business_partners': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'l'", 'max_length': '255'})
        },
        u'CMS.regions': {
